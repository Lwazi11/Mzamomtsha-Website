...
function emptyDateOfBirth(){
  ...
  if (document.getElementById("DoB").value == "" || !document.getElementById("DoB").value.match(/^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$/) ){
...
function emptyEmail(){
  ...
  if (document.getElementById("email").value == "" || !document.getElementById("email").value.match(/^[A-Za-z\._\-0-9]*[@][A-Za-z]*[\.][a-z]{2,4}$/)){
